...
const controller_auth_1 = __importDefault(require("../modules/auth/controller.auth"));
const blog_controller_1 = __importDefault(require("../modules/blog/blog.controller"));
const handleController = (app) => {
    app.use(express.json());
    app.use("/auth", controller_auth_1.default);
    app.use("/blog", blog_controller_1.default);
    (0, connectionDb_1.connectionDb)();
    app.get("/", (req, res) => {
        res.status(200).send("Hello World!");
    });
    app.use(error_handler_1.globelErrorHandler);
};
